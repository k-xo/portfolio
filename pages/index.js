                    ...
                    <div className='max-w-7xl mx-auto px-10 sm:px-6 lg:px-8'>
                        <div className='md:text-center'>
                            ...
                            <p className='mt-4 max-w-2xl text-xl text-gray-500 md:mx-auto'>
                                I'm a recent computer science graduate, skilled in MongoDB, Node, Express. Enthusiastic
                                about startups and venture capital and solving problems for the base of the pyramid
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className='flex flex-col'>
                        ...
                        <div className='flex-1 mx-6 border border-solid border-gray-400 rounded-md'>
                            <div className='mx-auto lg:flex lg:flex-row '>
                                <img
                                    ...
                                    alt=''
                                />
                                <a href='https://github.com/kassim99/yelp-camp' target='_blank'>
                                    <div className='bg-white p-8 rounded-bl-md rounded-br-md lg:rounded-bl-none lg:rounded-tr-md hover:bg-blue-100'>
                                        <h2 className='text-gray-700 font-semibold'>
                                            YelpCamp is a Full-Stack RESTful web application
                                        </h2>
                                        <p className='text-sm text-gray-600 mt-4'>
                                            User authorization/authentication using Passport.js Create a new campground
                                            Edit an existing campground Review a campground and see reviews RESTful
                                            routing using express Cloudinary for image upload and much more.
                                        </p>
                                        <div className='flex items-center mt-8'>
                                            <div className='flex items-center'>
                                                ...
                                                <div className='ml-4'>
                                                    ...
                                                    <p className='text-gray-600 text-sm'>27th August 2020</p>
                                                </div>
                                            </div>
                            ...
                            >
                                <div className='mx-auto lg:flex lg:flex-row '>
                                    ...
                                    <div className='bg-white p-8 rounded-bl-md rounded-br-md lg:rounded-bl-none lg:rounded-tr-md  hover:bg-blue-100'>
                                        ...
                                        <p className='text-sm text-gray-600 mt-4'>
                                            Rate Repository is a react-native application that allows you to rate Github
                                            repositories, the backend for this project was provided by fullstackopen,
                                            uses graphql, asyncstorage and much more
                                        </p>
                                        <div className='flex items-center mt-8'>
                                            <div className='flex items-center'>
                                                <img
                    ...
                    <div className='flex-1 mx-6 mt-8 border border-solid border-gray-400 rounded-md mb-32'>
                        ...
                        <div className='mx-auto  md:flex md:flex-row '>
                            ...
                            />
                            <a
                                href='https://portal.bazeuniversity.edu.ng/student/assets/thesis/202011131817071362722731.pdf'
                                target='_blank'
                            >
                                <div className='bg-white p-8 rounded-bl-md rounded-br-md lg:rounded-bl-none lg:rounded-tr-md hover:bg-blue-100'>
                                    <h2 className='text-gray-700 font-semibold'>
                                        iSight: An Object Detection System For The Visually Impaired
                                    </h2>
                                    <p className='text-sm text-gray-600 mt-4'>
                                        iSight provides an intuitive user experience, using TensorFlow Lite object
                                        recognition, where users can simply scan their surroundings and click anywhere
                                        on the screen to receive verbal feedback of the objects in their environment.
                                    </p>
                                    <div className='flex items-center mt-8'>
                                        <div className='flex items-center'>
                                            <img className='h-10 w-10 rounded-full' src='/images/profile.jpg' alt='' />
                                            <div className='ml-4'>
                                                <p className='text-gray-800 text-sm font-semibold'>Al-Kassim Kassim</p>
                                                <p className='text-gray-600 text-sm'>27th August 2020</p>
                                            </div>
                                        </div>
                                        <div className='w-8 h-8 ml-auto bg-gray-200 rounded-full flex items-center justify-center'>
